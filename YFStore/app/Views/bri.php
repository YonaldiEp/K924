...
<head>
    ...
    <title>Pembayaran - Transfer Bank BRI</title>
...
<body class="bg-gray-100">
    <div class="max-w-md mx-auto p-4" x-data="{ showModal: false }">
        <div class="bg-white space-y-4 shadow rounded-md p-5">
            ...
            <div id="bank-info">
                <p class="text-sm text-gray-700 text-base">Nama Bank: <span class="font-bold text-lg">Bank BRI</span></p>
                <p class="text-sm text-gray-700 text-base">Nomor Rekening: <span class="font-bold text-lg">0987654321</span></p>
